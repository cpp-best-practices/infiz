...
// configuration step. It creates a namespace called `infiz`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", infiz::cmake::project_name, infiz::cmake::project_version) };
